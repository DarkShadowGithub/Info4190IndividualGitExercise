...
It will house a simple Java program with six different branches (five for different features and one for the master). The Java program I have decided to make is a simple calculator.  
